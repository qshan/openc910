...
#if 1
  printf("[D]Get the argc is 0x%x\n", argc);
  //TOTO//ee_u32 loop_count = 0;
  //TOTO////int argc, char *argv[]
  //TOTO//for(loop_count=0;loop_count<argc;loop_count++)
  //TOTO//{
  //TOTO//  printf("Get the argc is 0x%x\n", argc);
  //TOTO//}

  printf("[D]Get macro MAIN_HAS_NOARGC is %d\n", MAIN_HAS_NOARGC);
